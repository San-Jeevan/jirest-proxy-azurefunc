...
namespace PublicProxyAzureFunction
{
    public static class corsBypass
    {
        [FunctionName("corsBypass")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            // Get request body
            CorsProxyRequest data = await req.Content.ReadAsAsync<CorsProxyRequest>();

            var resp = await ProxyOther(data);

            return req.CreateResponse(HttpStatusCode.OK, resp, "application/json");
        }
        ...
        public static async Task<CorsProxyResponse> ProxyOther(CorsProxyRequest req)
        {
            try
            {
